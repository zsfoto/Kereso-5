...
class CategoriesController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		if($search !== ''){
			...
			$query = $this->Categories->find()->where($conditions);
		}
		// ############################# /.QUERY ###########################################
    ...
    public function view($id = null)
    {
        ...
        $category = $this->Categories->get($id, contain: ['Companies']);
    ...
    public function add()
    {
        ...
        $companies = $this->Categories->Companies->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
    ...
    public function edit($id = null)
    {
        ...
        $companies = $this->Categories->Companies->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
		$name = $category->name;
        $this->set(compact('category', 'companies', 'id', 'name'));
    }
