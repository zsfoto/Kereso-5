...
class PhonesController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		$this->set('title', __('Browse the') . ': ' . __('Phones'));
		...
		$this->paginate['Phones']['page'] 	= $page;
		$this->paginate['Phones']['order'] 	= [$sort => $direction];
		// ############################# /.SORT ORDER & PAGE ###############################
		...
		if($search !== ''){
			...
			$query = $this->Phones->find()->where($conditions);
		}
		// ############################# /.QUERY ###########################################
		...
		// ############################# PAGINATE ############################################
		try {
			$this->paginate['Phones']['limit'] = $this->config['paginate_limit'];
			$phones = $this->paginate($query);
    ...
    public function view($id = null)
    {
		...
		$this->set('title', __('View the') . ': ' . __('phone') . ' ' . __('record'));
    ...
    public function add()
    {
		...
		$this->set('title', __('Add new') . ': ' . __('phone') . ' ' . __('record'));
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Phones->save($phone)) {
                //$this->Flash->success(__('The phone has been saved.'), ['plugin' => 'JeffAdmin5']);
            ...
            //$this->Flash->error(__('The phone could not be saved. Please, try again.'), ['plugin' => 'JeffAdmin5']);
    ...
    public function edit($id = null)
    {
		...
		$this->set('title', __('Edit the') . ': ' . __('phone') . ' ' . __('record'));
		$this->session->write('Layout.' . $this->controller . '.LastId', $id);
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Phones->delete($phone)) {
            ...
            //$this->Flash->success(__('The phone has been deleted.'), ['plugin' => 'JeffAdmin5']);
            $this->Flash->success(__('The has been deleted.'), ['plugin' => 'JeffAdmin5']);
        } else {
            //$this->Flash->error(__('The phone could not be deleted. Please, try again.'), ['plugin' => 'JeffAdmin5']);
