								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: keywords_slug: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="keywords-slug"><?= __('Keywords Slug') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('keywords_slug', ['label' => __('Keywords Slug'), 'placeholder' => __('Keywords Slug'), 'class' => 'form-control', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: icon_type: string  -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="icon-type"><?= __('Icon Type') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('icon_type', ['label' => __('Icon Type'), 'placeholder' => __('Icon Type'), 'class' => 'form-control', 'empty' => true]); ?>

												</div>
											</div>

											<!-- 2. STRING: icon: string  -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="icon"><?= __('Icon') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('icon', ['label' => __('Icon'), 'placeholder' => __('Icon'), 'class' => 'form-control', 'empty' => true]); ?>
