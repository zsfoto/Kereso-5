								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 8. ELSE: zip: char  required not in ['string', 'integer', 'datetime', 'date', 'time', 'boolean'] -->
											<?php //$this->Form->control('zip', ['class' => 'form-control']); ?>
											...
											<!-- 2. STRING: latitude: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="latitude"><?= __('Latitude') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('latitude', ['label' => __('Latitude'), 'placeholder' => __('Latitude'), 'class' => 'form-control', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: longitude: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="longitude"><?= __('Longitude') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('longitude', ['label' => __('Longitude'), 'placeholder' => __('Longitude'), 'class' => 'form-control', 'empty' => false]); ?>
