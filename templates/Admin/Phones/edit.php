...
$this->assign('title', __('Edit') . ' ' . __('Phone'));
?>
				<div id="form-row" class="phones row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Phone') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($phone, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 8. ELSE: phone_area: char  not in ['string', 'integer', 'datetime', 'date', 'time', 'boolean'] -->
											<?php //$this->Form->control('phone_area', ['class' => 'form-control']); ?>
											<!-- 8. ELSE: phone_number: char  not in ['string', 'integer', 'datetime', 'date', 'time', 'boolean'] -->
											<?php //$this->Form->control('phone_number', ['class' => 'form-control']); ?>
											<!-- 8. ELSE: phone_annex: char  not in ['string', 'integer', 'datetime', 'date', 'time', 'boolean'] -->
											<?php //$this->Form->control('phone_annex', ['class' => 'form-control']); ?>
