						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Phone') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>
								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Phones", "action" => "index", "_full" => true],
...
<?php } ?>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Phone Country') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($phone->phone_country) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Phone Area') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($phone->phone_area) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Phone Number') ?>:</label>
												<div class="col-sm-10 p-1">
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Phone Annex') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($phone->phone_annex) ?>
											...
											<div class="row"><!-- 3. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($phone->person_id) ?><!-- 3.b -->
												</div>
											</div>
